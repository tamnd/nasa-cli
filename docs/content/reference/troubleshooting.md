...
Most of these come down to network reality or how nasa serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nasa rate-limits like any public site. nasa already paces
...
Where a surface is gated, nasa reads a cookie or token you supply
...
`nasa`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nasa actually did
